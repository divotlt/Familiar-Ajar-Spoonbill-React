...
const Page = (props) => {
  return (
    <div className="page-container">
      <Helmet>
        <title>Page - Familiar Ajar Spoonbill</title>
        <meta property="og:title" content="Page - Familiar Ajar Spoonbill" />
      </Helmet>
      <header data-role="Header" className="page-header">
        ...
        <div data-role="BurgerMenu" className="page-burger-menu">
        ...
        <div data-role="MobileMenu" className="page-mobile-menu">
          <div className="page-nav1">
            <div className="page-container2">
              ...
              <div
                ...
                className="page-close-mobile-menu"
              >
