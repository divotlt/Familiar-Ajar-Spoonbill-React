...
const Prompts = (props) => {
  return (
    <div className="prompts-container">
      <Helmet>
        <title>Prompts - Familiar Ajar Spoonbill</title>
        <meta property="og:title" content="Prompts - Familiar Ajar Spoonbill" />
      </Helmet>
      <header data-role="Header" className="prompts-header">
        <div className="prompts-container1">
          <span className="prompts-text">
            <span>The Scarlet Project</span>
            <br></br>
          </span>
        </div>
        <span className="prompts-date-time">
          <DateTimePrimitive
            format="DD/MM/YYYY"
            date="Thu Feb 22 2024 18:11:35 GMT-0800 (Pacific Standard Time)"
          ></DateTimePrimitive>
        </span>
        <span className="prompts-date-time1">
          <DateTimePrimitive
            format="h:mm A"
            date="Thu Feb 22 2024 18:11:35 GMT-0800 (Pacific Standard Time)"
          ></DateTimePrimitive>
        ...
        <div data-role="BurgerMenu" className="prompts-burger-menu">
          <svg viewBox="0 0 1024 1024" className="prompts-icon">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div data-role="MobileMenu" className="prompts-mobile-menu">
          <div className="prompts-nav1">
            <div className="prompts-container2">
              <img
                alt="image"
                src="https://presentation-website-assets.teleporthq.io/logos/logo.png"
                className="prompts-image"
              />
              <div
                data-role="CloseMobileMenu"
                className="prompts-close-mobile-menu"
              >
                <svg viewBox="0 0 1024 1024" className="prompts-icon02">
      ...
      <div className="prompts-container3">
        <div className="prompts-container4">
          <Script
            html={`<!DOCTYPE html>
<html lang="en">
<head>
